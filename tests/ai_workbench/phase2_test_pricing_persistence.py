...
def test_reprice_uses_historical_trusted_snapshot(tmp_path):
    with connect_workbench_db(tmp_path / "db.sqlite") as conn:
        conn.execute("INSERT INTO observations(id,observation_kind,source,tool,model,provider,observed_at,payload_hash,quality,parser_version,parse_status,created_at) VALUES('o','session','codex_jsonl','codex','m','p','2026-01-02T00:00:00Z','h','exact','v','parsed','2026-01-02T00:00:00Z')")
